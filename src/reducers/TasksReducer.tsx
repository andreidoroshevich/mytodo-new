...
export const TasksReducer = (state: TaskObjectType, action: ActionType) => {
    switch (action.type) {
        case "REMOVE-TASK": {
            return {
        ...
        case "CHANGE-TASK-STATUS" : {
            return {
                ...state, [action.todoListID]: state[action.todoListID].map(el => el.id === action.taskID ? {...el, isDone: action.isDoneValue} : el)
            }
        }
